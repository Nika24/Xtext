...
public class EntityStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new EntityRuntimeModule());
	}
	
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/example/Entity")) {
			EPackage.Registry.INSTANCE.put("http://www.xtext.org/example/Entity", EntityPackage.eINSTANCE);
		}
